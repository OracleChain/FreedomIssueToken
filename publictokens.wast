(module
 ...
 (data (i32.const 2240) "transfer\00")
 (data (i32.const 2256) "totalsupply[\00")
 ...
 (func $_ZN11eosdactoken11issue_tokenEyyN5eosio5assetENSt3__112basic_stringIcNS2_11char_traitsIcEENS2_9allocatorIcEEEE (param $0 i32) (param $1 i64) (param $2 i64) (param $3 i32) (param $4 i32)
  ...
  (block $label$0
   (block $label$1
    ...
    (call $_ZN11eosdactoken6createEyN5eosio5assetE
     (get_local $0)
     (get_local $2)
     (i32.add
      (get_local $15)
    ...
    (call $_ZN11eosdactoken5issueEyN5eosio5assetENSt3__112basic_stringIcNS2_11char_traitsIcEENS2_9allocatorIcEEEE
     (get_local $0)
     (get_local $1)
     (get_local $15)
     (i32.add
